        ...
        <v-col>
            <v-card class="rounded-lg">
                <div class="bottom">
                    ...
                    构建日期：
                    {{ store.compileInfo.compileDate }}
                    <br>
                    构建号：
                    {{ store.compileInfo.compileNumber }}
                    <br>
                    构建平台：
...
import SingleWidthPointSwitcher from "@/components/ResponsiveLayout/SingleWidthPointSwitcher.vue";
